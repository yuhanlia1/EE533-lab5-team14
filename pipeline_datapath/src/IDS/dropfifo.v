...
//  \___\/\___\ 
//
//Command: C:\Xilinx\10.1\ISE\bin\nt\unwrapped\sch2verilog.exe -intstyle ise -family virtex2p -w "C:/Documents and Settings/student/Desktop/EE533/Lab3/dropfifo.sch" dropfifo.vf
...
module dropfifo(clk, 
   ...
   dpmem9B XLXI_1 (.addra(waddr[7:0]), 
                   .addrb(raddr[7:0]), 
                   .clka(clk), 
                   .clkb(clk), 
                   .dina(in_fifo0[71:0]), 
   ...
   comp8_MUSER_dropfifo XLXI_7 (.A(waddr[7:0]), 
                                .B(raddr[7:0]), 
                                .EQ(XLXN_30));
   comp8_MUSER_dropfifo XLXI_8 (.A(raddr[7:0]), 
                                .B(XLXN_18[7:0]), 
                                .EQ(XLXN_28));
   OR2 XLXI_9 (.I0(XLXN_2), 
               .I1(XLXN_1), 
               .O(XLXN_3));
   AND2B1 XLXI_10 (.I0(XLXN_42), 
                   .I1(XLXN_3), 
                   .O(XLXN_51));
